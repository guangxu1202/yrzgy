...
namespace Model;
use Think\Model;
class Person_introModel extends Model{
    //获取全部验证错误
    ...
    protected $_validate = array(
        ...
        //验证摘要简介
        array('summary','0,200','简介长度必须在0到200之间！',3,'length'),
        ...
        //照片描述
        array("photo_describe","require","照片描述不能为空"),
        array('photo_describe','1,20','照片描述长度必须在1到20之间！',3,'length'),

        //成员照片
        array("photo","require","请上传成员照片"),
